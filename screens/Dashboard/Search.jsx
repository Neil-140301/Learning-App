...
const Search = () => {
  ...
  const renderTopSearches = useCallback(() => {
    return (
      <View style={{ marginTop: SIZES.padding }}>
        ...
        <FlatList
          ...
          listKey="TopSearches"
          keyExtractor={(i) => `TopSearches-${i.id}`}
  ...
  }, [SIZES, FONTS, COLORS, dummyData]);

  const renderBrowseCategories = useCallback(() => {
    return (
      <View
        style={{
      ...
      >
        ...
        <FlatList
          ...
          keyExtractor={(i) => `BrowseCategories-${i.id}`}
          contentContainerStyle={{ marginTop: SIZES.radius }}
          renderItem={({ item, index }) => (
            <CategoryCard
